...
class PlainExist:
    ...
    def __init__(self, silent = False):
        ...
        if (self.__filepaths != None): self.__filepaths = self.__filepaths.split(";")
        if (self.__dirpaths != None): self.__dirpaths = self.__dirpaths.split(";")
    ...
    def __verify_files(self):
        if (self.__filepaths == None): return
    ...
    def __verify_dirs(self):
        if (self.__dirpaths == None): return
